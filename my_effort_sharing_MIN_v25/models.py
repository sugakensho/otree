...
class Group(BaseGroup):
    ...
    def set_payoffs(self):
        ...
        if team_type == 1 :
            p1.yeild = p1.effort_amount*0.75 + Constants.endowment1 +  random.uniform(0,40) 
            p2.yeild = p2.effort_amount*0.75 + Constants.endowment1 +  random.uniform(0,40) 
            p3.yeild = p3.effort_amount + p1.effort_amount*0.25 + Constants.endowment2 +  random.uniform(0,40) 
            p4.yeild = p4.effort_amount + p2.effort_amount*0.25 + Constants.endowment2 +  random.uniform(0,40) 
            ...
            p1.effort_sharing_amount = p1.effort_amount*0.25
            p2.effort_sharing_amount = p2.effort_amount*0.25
            p3.effort_sharing_amount = p1.effort_amount*0.25
            p4.effort_sharing_amount = p2.effort_amount*0.25
            ...
            p1.yeild = p1.effort_amount*0.75 + Constants.endowment1 +  random.uniform(0,40) 
            p2.yeild = p2.effort_amount*0.75 + Constants.endowment1 +  random.uniform(0,40) 
            p3.yeild = p3.effort_amount + p2.effort_amount*0.25 + Constants.endowment2 +  random.uniform(0,40) 
            p4.yeild = p4.effort_amount + p1.effort_amount*0.25 + Constants.endowment2 +  random.uniform(0,40) 
            ...
            p1.effort_sharing_amount = p1.effort_amount*0.25
            p2.effort_sharing_amount = p2.effort_amount*0.25
            p3.effort_sharing_amount = p2.effort_amount*0.25
            p4.effort_sharing_amount = p1.effort_amount*0.25
