...
class Constants(BaseConstants):
    name_in_url = 'my_effort_sharing_MAX_v50'
    players_per_group = 4
    num_rounds = 5
...
class Group(BaseGroup):
    ...
    def set_payoffs(self):
        ...
        if team_type == 1 :
            p1.yeild = p1.effort_amount + p3.effort_amount*0.50 + Constants.endowment1 +  random.uniform(-50,50) 
            p2.yeild = p2.effort_amount + p4.effort_amount*0.50 + Constants.endowment1 +  random.uniform(-50,50) 
            p3.yeild = p3.effort_amount*0.5 + Constants.endowment2 +  random.uniform(-50,50) 
            p4.yeild = p4.effort_amount*0.5 + Constants.endowment2 +  random.uniform(-50,50) 
            ...
            p1.effort_sharing_amount = p3.effort_amount*0.5
            p2.effort_sharing_amount = p4.effort_amount*0.5
            p3.effort_sharing_amount = p3.effort_amount*0.5
            p4.effort_sharing_amount = p4.effort_amount*0.5
            ...
            p1.yeild = p1.effort_amount + p4.effort_amount*0.5 + Constants.endowment1 +  random.uniform(-50,50) 
            p2.yeild = p2.effort_amount + p3.effort_amount*0.5 + Constants.endowment1 +  random.uniform(-50,50) 
            p3.yeild = p3.effort_amount*0.5 + Constants.endowment2 +  random.uniform(-50,50) 
            p4.yeild = p4.effort_amount*0.5 + Constants.endowment2 +  random.uniform(-50,50) 
            ...
            p1.effort_sharing_amount = p4.effort_amount*0.5
            p2.effort_sharing_amount = p3.effort_amount*0.5
            p3.effort_sharing_amount = p3.effort_amount*0.5
            p4.effort_sharing_amount = p4.effort_amount*0.5
